...
function Main({ acc, web3main }) {
    ...
    const myreward = fildata?.reduce((pre, curr)=>(Number(curr[8])+pre),0)
                                ...
                                <div className='card shadow'>
                                    ...
                                    <div className='cardbody'>
                                        ...
                                        <div className='d-flex justify-content-between px-3'>
                                            <p style={{ fontSize: '20px' }}>Total Nft:</p>
                                            <p style={{ fontSize: '20px', fontWeight: 'bold' }}>{v?.total}</p>
                                        </div>
                                        {/* <div className='d-flex justify-content-between px-3'>
                                        ...
                                        <div className='onbtn'>
                                            <a href={`/category/${v?.name}`}>
                                                <button>View Staked NFTs</button>
                                            </a>
